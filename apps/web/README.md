...
the API contract for expiring/revocable analyst invites, one-time raw token and
invite URL handling, audited invite delivery, password setup at acceptance,
invite health monitoring, MFA readiness attestation, aggregated security
readiness, analyst disable/session revocation, and reactivation, plus
