...
setup at acceptance, persistent local delivery attempts, invite health monitoring, MFA readiness attestation,
aggregated security readiness, analyst disable/session revocation, and reactivation, plus
