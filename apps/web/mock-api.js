(() => {
  ...
  const POSTGRESQL_REPOSITORY_ADAPTER_CONTRACT = {
    ...
    version: "postgresql-repository-adapter-v8",
    status: "partial_method_groups",
    stage: "model_registry_audit_organizations_identity_invites_applications_groups_v1",
    present: true,
    ...
    limitation: "PostgreSQL Repository Adapter v8 implements the model registry, audit, organization, identity/session, staff invite delivery, and application lifecycle method groups through an injected DB-API compatible connection factory. Runtime backend selection remains disabled until tenant-scoped simulation and analytics flows have repository parity coverage.",
  };
    ...
    return {
      ...
      parity_checks: [
        ...
        },
        {
          ...
          action: "Use the completed organization, staff invite, and application adapter groups as tenant-boundary evidence, then add repository parity tests for analytics and simulations.",
        },
        {
        ...
        },
        {
          ...
          status: "pass",
          sqlite_evidence: "52 SQLite repository method(s) are grouped into adapter contract families; 47 method(s) currently have PostgreSQL adapter coverage.",
        ...
        },
        {
          ...
          action: "Use the completed organization adapter group as the tenant boundary foundation while preserving application and invite tenant scoping before simulation and analytics parity.",
        },
        {
          ...
          action: "Use the completed identity access adapter group as the security foundation before simulation and analytics parity.",
        },
        {
          ...
          action: "Use the completed staff invite delivery group as the tenant-scoped access onboarding foundation before simulation and analytics parity.",
        },
        {
          ...
          action: "Use the completed application lifecycle group as the core loan workflow foundation before portfolio simulation and analytics parity.",
        },
        {
          key: "postgresql_repository_backend",
          status: "blocker",
          sqlite_evidence: "Runtime repository supports sqlite only and rejects postgresql at startup; the adapter has complete model registry, audit, organization, identity/session, staff invite delivery, and application lifecycle method groups but does not yet cover the full repository contract.",
          postgres_requirement: "Implement a PostgreSQL repository backend behind the same API contract.",
          action: "Expand the PostgreSQL adapter from model registry, audit, organization, identity/session, staff invite delivery, and application lifecycle flows to tenant-scoped simulations and analytics.",
        },
        {
