...
| Staff lifecycle | Expiring/revocable analyst invites, invite health, MFA/security readiness, and disable/reactivation with session revocation and audit events |
