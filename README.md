...
| Staff lifecycle | Expiring/revocable analyst invites, audited invite delivery, safe invite rotation, invite health, MFA/security readiness, and disable/reactivation with session revocation and audit events |
