...
async function main() {
  ...
  if (
    ...
    || postgresqlReadinessInitial.repository_adapter_completed_method_group_count !== 7
    ...
    || !postgresqlReadinessInitial.repository_adapter_portfolio_analytics_group_present
