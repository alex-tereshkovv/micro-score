...
def run_workflow(client: ApiClient) -> dict[str, Any]:
    ...
    assert_true(
        ...
        and postgresql_readiness["repository_adapter_completed_method_group_count"] == 7
        and (
            "identity_access"
        ...
        and postgresql_readiness["repository_adapter_portfolio_analytics_group_present"]
        and any(
