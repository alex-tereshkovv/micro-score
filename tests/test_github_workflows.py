...
class GithubWorkflowTests(unittest.TestCase):
    ...
    def test_static_demo_smoke_script_exercises_reviewer_flow(self) -> None:
        ...
        self.assertIn("staff_invite_delivery_adapter_readiness", script)
        self.assertIn("staff_invite_delivery_adapter_boundary", script)
        ...
        self.assertIn("/admin/staff-invites/delivery-adapter-readiness", script)
