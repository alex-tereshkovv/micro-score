...
class GithubWorkflowTests(unittest.TestCase):
    ...
    def test_static_demo_smoke_script_exercises_reviewer_flow(self) -> None:
        ...
        self.assertIn("staff_invite_delivery_worker", script)
        self.assertIn("staff_invite_delivery_dead_letter", script)
        ...
        self.assertIn("/admin/security/mfa-readiness", script)
        self.assertIn("/mfa/attest", script)
        self.assertIn("/disable", script)
        self.assertIn("/reactivate", script)
        self.assertIn("/admin/staff-invites", script)
        self.assertIn("/admin/staff-sessions", script)
        self.assertIn("/admin/staff-invites/health", script)
        self.assertIn("/admin/staff-invites/delivery-outbox", script)
        self.assertIn("/admin/staff-invites/delivery-outbox/run", script)
        self.assertIn("/delivery-attempts", script)
        self.assertIn("/delivery-attempts/retry", script)
        self.assertIn("local_fail", script)
