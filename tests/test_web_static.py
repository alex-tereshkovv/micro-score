...
class WebStaticTests(unittest.TestCase):
    ...
    def test_html_loads_styles_and_script(self) -> None:
        ...
        self.assertIn('href="./styles.css?v=20260804-mfi-command-flow-v1"', html)
        ...
        self.assertIn('src="./mock-api.js?v=20260804-mfi-command-flow-v1"', html)
        self.assertIn('src="./portfolio-dashboard.js?v=20260623-dashboard"', html)
        self.assertIn('src="./app.js?v=20260804-mfi-command-flow-v1"', html)
        ...
        self.assertIn('class="panel mfi-detail-panel"', html)
        ...
        queue_panel_start = html.rfind('<section class="panel', mfi_view_start, queue_heading)
        risk_panel_start = html.rfind('<section class="panel', mfi_view_start, risk_heading)
        self.assertLess(queue_heading, risk_heading)
        self.assertIn('<section class="panel">', html[queue_panel_start : queue_panel_start + 80])
        self.assertIn(
            '<section class="panel mfi-detail-panel">',
