...
class WebStaticTests(unittest.TestCase):
    ...
    def test_html_loads_styles_and_script(self) -> None:
        ...
        self.assertIn('href="./styles.css?v=20260730-postgres-organizations-group-v1"', html)
        ...
        self.assertIn('src="./mock-api.js?v=20260730-postgres-organizations-group-v1"', html)
        self.assertIn('src="./portfolio-dashboard.js?v=20260623-dashboard"', html)
        self.assertIn('src="./app.js?v=20260730-postgres-organizations-group-v1"', html)
    ...
    def test_frontend_targets_current_api_contract(self) -> None:
        ...
        self.assertIn("postgresql-repository-adapter-v5", mock_script)
        self.assertIn("partial_method_groups", mock_script)
        self.assertIn("model_registry_audit_organizations_groups_v1", mock_script)
        self.assertIn("postgresql_repository_adapter_contract", mock_script)
