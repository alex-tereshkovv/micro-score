...
class WebStaticTests(unittest.TestCase):
    ...
    def test_html_loads_styles_and_script(self) -> None:
        ...
        self.assertIn('src="./risk-detail.js?v=20260622-risk-detail"', html)
        self.assertIn('src="./mock-api.js?v=20260622-risk-detail"', html)
        self.assertIn('src="./app.js?v=20260622-risk-detail"', html)
