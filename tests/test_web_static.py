...
class WebStaticTests(unittest.TestCase):
    ...
    def test_html_loads_styles_and_script(self) -> None:
        ...
        self.assertIn('href="./styles.css?v=20260804-mfi-form-flow-v1"', html)
        ...
        self.assertIn('src="./mock-api.js?v=20260804-mfi-form-flow-v1"', html)
        self.assertIn('src="./portfolio-dashboard.js?v=20260623-dashboard"', html)
        self.assertIn('src="./app.js?v=20260804-mfi-form-flow-v1"', html)
