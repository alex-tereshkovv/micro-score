...
class ResearchDocsTests(unittest.TestCase):
    ...
    def test_demo_and_benchmark_docs_define_portfolio_next_steps(self) -> None:
        ...
        self.assertIn("Portfolio Dashboard v2", demo_plan)
    ...
    def test_reviewer_demo_assets_define_safe_walkthrough(self) -> None:
        ...
        self.assertIn("Portfolio Dashboard v2", walkthrough)
        ...
        self.assertIn("Portfolio dashboard smoke test", release_checklist)
        self.assertIn("settlement mix", release_checklist)
        ...
        self.assertIn("03-mfi-portfolio-dashboard-v2.png", screenshot_checklist)
        self.assertIn("Risk Detail v2 + Model-Use Notice", screenshot_checklist)
        self.assertIn("settlement mix", screenshot_checklist)
    ...
    def test_reviewer_brief_and_architecture_define_product_story(self) -> None:
        ...
        self.assertIn("Portfolio Dashboard v2", architecture)
    ...
    def test_api_contract_documents_session_security(self) -> None:
        ...
        self.assertIn("session_expires_at", api_contract)
        self.assertIn("session_ttl_seconds", api_contract)
        self.assertIn("GET /me", api_contract)
        ...
        self.assertIn("Session Security v2", (DOCS_ROOT / "PRODUCT_ROADMAP.md").read_text(encoding="utf-8"))
        self.assertIn("visible expiry metadata", (DOCS_ROOT / "ARCHITECTURE.md").read_text(encoding="utf-8"))
        ...
        self.assertIn("POST /admin/users/{email}/disable", api_contract)
        self.assertIn("disabled_at", api_contract)
        self.assertIn("disabled_by", api_contract)
        self.assertIn("revokes all active", api_contract)
        self.assertIn("Account disabled", api_contract)
        self.assertIn("was_already_disabled", api_contract)
        self.assertIn("staff_user_disabled", api_contract)
        self.assertIn("POST /admin/users/{email}/reactivate", api_contract)
        self.assertIn("staff_user_reactivated", api_contract)
        self.assertIn("was_already_active", api_contract)
        self.assertIn("must sign in again", api_contract)
        self.assertIn("GET /admin/staff-sessions", api_contract)
        self.assertIn("DELETE /admin/staff-sessions/{session_id}", api_contract)
        self.assertIn("session_preview", api_contract)
        self.assertIn("staff_session_revoked", api_contract)
        self.assertIn("never returns raw bearer tokens", api_contract)
        self.assertIn("POST /admin/staff-invites", api_contract)
        self.assertIn("POST /admin/staff-invites/{token_id}/delivery", api_contract)
        self.assertIn("GET /admin/staff-invites/{token_id}/delivery-attempts", api_contract)
        self.assertIn("POST /admin/staff-invites/{token_id}/delivery-attempts/retry", api_contract)
        self.assertIn("POST /admin/staff-invites/{token_id}/rotate", api_contract)
        self.assertIn("GET /admin/staff-invites/health", api_contract)
        self.assertIn("GET /admin/staff-invites/delivery-readiness", api_contract)
        self.assertIn("GET /admin/staff-invites/delivery-adapter-readiness", api_contract)
        self.assertIn("GET /admin/staff-invites/delivery-outbox", api_contract)
        self.assertIn("POST /admin/staff-invites/delivery-outbox/run", api_contract)
        self.assertIn("GET /admin/staff-invites/{token_id}/delivery-events", api_contract)
        self.assertIn("POST /webhooks/staff-invite-delivery", api_contract)
        self.assertIn("expiring_soon_count", api_contract)
        self.assertIn("action_required_count", api_contract)
        self.assertIn("recommended_action", api_contract)
        self.assertIn("delivery_provider_not_production_ready", api_contract)
        self.assertIn("delivery_provider_configuration_missing", api_contract)
        self.assertIn("MICROSCORE_TRANSACTIONAL_EMAIL_API_KEY", api_contract)
        self.assertIn("X-MicroScore-Delivery-Signature", api_contract)
        self.assertIn("staff_invite_delivery_webhook_received", api_contract)
        self.assertIn("staff_invite_delivery_worker_run", api_contract)
        self.assertIn("external_send_adapter_disabled", api_contract)
        self.assertIn("invite_secret_material_not_available", api_contract)
        self.assertIn("adapter_idempotency_key", api_contract)
        self.assertIn("raw_invite_token", api_contract)
        self.assertIn("worker_status", api_contract)
        self.assertIn("retry_scheduled", api_contract)
        self.assertIn("dead_letter", api_contract)
        self.assertIn("transactional_email", api_contract)
        self.assertIn("sending external email", api_contract)
        self.assertIn("GET /admin/security/mfa-readiness", api_contract)
        self.assertIn("GET /admin/security/readiness", api_contract)
        self.assertIn("POST /admin/users/{email}/mfa/attest", api_contract)
        self.assertIn("missing_mfa_count", api_contract)
        self.assertIn("blockers_count", api_contract)
        self.assertIn("recommended_actions", api_contract)
        self.assertIn("not a completed production security review", api_contract)
        self.assertIn("staff_mfa_attested", api_contract)
        self.assertIn("staff_mfa_login_verified", api_contract)
        self.assertIn("staff_mfa_challenge_failed", api_contract)
        self.assertIn("mfa_challenge_failures", api_contract)
        self.assertIn("missing_attestation", api_contract)
        self.assertIn("requires a second-factor code", api_contract)
        self.assertIn("DELETE /admin/staff-invites/{token_id}", api_contract)
        self.assertIn("POST /auth/accept-staff-invite", api_contract)
        self.assertIn("one-time raw `token`", api_contract)
        self.assertIn("one-time `invite_url`", api_contract)
        self.assertIn("token_id", api_contract)
        self.assertIn("token_preview", api_contract)
        self.assertIn("delivery_url_base", api_contract)
        self.assertIn("queue_delivery", api_contract)
        self.assertIn("delivery_attempt_count", api_contract)
        self.assertIn("local_outbox", api_contract)
        self.assertIn("local_queue", api_contract)
        self.assertIn("local_fail", api_contract)
        self.assertIn("invite_delivery_attempts", api_contract)
        self.assertIn("manual_receipt", api_contract)
        self.assertIn("was_already_delivered", api_contract)
        self.assertIn("staff_invite_rotation", api_contract)
        self.assertIn("staff_invite_created", api_contract)
        self.assertIn("staff_invite_delivery_attempted", api_contract)
        self.assertIn("staff_invite_delivered", api_contract)
        self.assertIn("staff_invite_rotated", api_contract)
        self.assertIn("staff_invite_accepted", api_contract)
        self.assertIn("staff_invite_revoked", api_contract)
        self.assertIn("Staff Invite v3", api_contract)
        self.assertIn("MFA", api_contract)
    ...
    def test_monte_carlo_methodology_sets_statistical_boundaries(self) -> None:
        ...
        self.assertIn("Monte Carlo standard errors", methodology)
        self.assertIn("portfolio_fingerprint", methodology)
        self.assertIn("GET /mfi/simulations/{simulation_id}", methodology)
        self.assertIn("POST /mfi/simulations/portfolio", api_contract)
        self.assertIn("GET /mfi/simulations", api_contract)
        self.assertIn("PortfolioSimulationSummary", api_contract)
        self.assertIn("cross-tenant detail access returns `403`", api_contract)
