...
class ApiIntegrationTests(unittest.TestCase):
    ...
    def test_openapi_exposes_product_response_schemas(self) -> None:
        ...
        postgres_readiness_properties = schemas["PostgresMigrationReadinessResponse"][
            "properties"
        ]
        self.assertIn("repository_adapter_stage", postgres_readiness_properties)
        self.assertIn(
            "repository_adapter_implemented_method_count",
            postgres_readiness_properties,
        )
        self.assertIn(
        ...
        adapter_group_properties = schemas[
            "PostgresRepositoryAdapterContractGroupResponse"
        ]["properties"]
        self.assertIn("implemented_methods", adapter_group_properties)
        self.assertIn("pending_methods", adapter_group_properties)
    ...
    def test_admin_pre_pilot_readiness_aggregates_release_controls(self) -> None:
        ...
        self.assertEqual(
            checks["storage_backend"]["evidence"][
                "postgresql_repository_adapter_completed_method_groups"
            ],
            [
                "identity_access",
                "organizations",
    ...
    def test_admin_postgresql_readiness_exposes_migration_parity_contract(self) -> None:
        ...
        self.assertEqual(
            ...
            "postgresql-repository-adapter-v7",
        )
        self.assertEqual(
        ...
        self.assertEqual(payload["repository_adapter_implemented_method_count"], 37)
        self.assertEqual(payload["repository_adapter_pending_method_count"], 15)
        self.assertEqual(payload["repository_adapter_read_only_method_count"], 17)
        self.assertEqual(payload["repository_adapter_write_method_count"], 20)
        self.assertEqual(payload["repository_adapter_completed_method_group_count"], 5)
        self.assertEqual(
        ...
        self.assertTrue(payload["repository_adapter_model_registry_read_present"])
        self.assertTrue(payload["repository_adapter_model_registry_write_present"])
        self.assertTrue(payload["repository_adapter_model_registry_group_present"])
        self.assertTrue(payload["repository_adapter_audit_group_present"])
        self.assertTrue(payload["repository_adapter_organization_group_present"])
        self.assertTrue(payload["repository_adapter_identity_access_group_present"])
        self.assertTrue(
            payload["repository_adapter_staff_invites_delivery_group_present"]
        )
        self.assertIn(
            "list_model_versions",
        ...
        self.assertEqual(
            adapter_groups["staff_invites_delivery"]["implemented_method_count"],
            15,
        )
        self.assertEqual(
            adapter_groups["staff_invites_delivery"]["pending_method_count"],
            0,
        )
        self.assertFalse(adapter_groups["staff_invites_delivery"]["pending_methods"])
        ...
        self.assertEqual(
            parity["postgresql_model_registry_read_adapter"]["status"],
            "pass",
        )
        self.assertEqual(
            parity["postgresql_model_registry_method_group_adapter"]["status"],
            "pass",
        )
        self.assertEqual(
            parity["postgresql_audit_method_group_adapter"]["status"],
            "pass",
        )
        self.assertEqual(
            parity["postgresql_organization_method_group_adapter"]["status"],
            "pass",
        )
        self.assertEqual(
            parity["postgresql_identity_access_method_group_adapter"]["status"],
            "pass",
        )
        self.assertEqual(
            parity[
