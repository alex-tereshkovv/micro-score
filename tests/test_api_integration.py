...
class ApiIntegrationTests(unittest.TestCase):
    ...
    def test_admin_postgresql_readiness_exposes_migration_parity_contract(self) -> None:
        ...
        self.assertEqual(payload["repository_adapter_contract_status"], "partial_method_group")
        ...
        self.assertEqual(payload["repository_adapter_stage"], "model_registry_method_group_v1")
        self.assertEqual(payload["repository_adapter_contract_method_count"], 52)
        self.assertEqual(payload["repository_adapter_implemented_method_count"], 5)
        self.assertEqual(payload["repository_adapter_pending_method_count"], 47)
        self.assertEqual(payload["repository_adapter_read_only_method_count"], 3)
        self.assertEqual(payload["repository_adapter_write_method_count"], 2)
        self.assertEqual(payload["repository_adapter_completed_method_group_count"], 1)
        self.assertEqual(
